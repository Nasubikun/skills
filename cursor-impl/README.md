...
```bash
npx skills add Nasubikun/skills --skill cursor-impl
```

または手動で:

```bash
git clone https://github.com/Nasubikun/skills /tmp/nasubikun-skills
cp -R /tmp/nasubikun-skills/cursor-impl ~/.claude/skills/cursor-impl
```
